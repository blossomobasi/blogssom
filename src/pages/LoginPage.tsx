			...
			<div className="w-[30rem]">
				...
				<form className="flex flex-col space-y-3" onSubmit={handleSubmit(onSubmit)}>
					...
					<div className="border flex items-center focus-within:border-black">
						...
						/>
						<span onClick={() => setShowPassword((show) => !show)} className="px-3 cursor-pointer">
							{showPassword ? <FaRegEyeSlash size={25} /> : <MdOutlineRemoveRedEye size={25} />}
						</span>
					</div>
					...
					<button
						className={clsx("bg-black text-white py-3 font-semibold flex items-center justify-center", {
